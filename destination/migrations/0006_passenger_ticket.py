# Generated by Django 4.0.2 on 2023-04-27 09:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='destination.flight')),
                ('passengers', models.ManyToManyField(related_name='flight_tickets', to='destination.Passenger')),
